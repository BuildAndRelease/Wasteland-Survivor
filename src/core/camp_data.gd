...
const UPGRADES: Dictionary = {
	"health_boost": {
		...
		"max_level": 5,
		"levels": [
			{"cost": 100, "effect": 0.10, "desc": "+10% Max HP"},
			{"cost": 150, "effect": 0.20, "desc": "+20% Max HP"},
			{"cost": 250, "effect": 0.30, "desc": "+30% Max HP"},
			{"cost": 400, "effect": 0.40, "desc": "+40% Max HP"},
			{"cost": 500, "effect": 0.50, "desc": "+50% Max HP"},
		],
	},
	"attack_boost": {
		"id": "attack_boost",
		...
		"max_level": 5,
		"levels": [
			{"cost": 100, "effect": 0.10, "desc": "+10% Attack"},
			{"cost": 150, "effect": 0.20, "desc": "+20% Attack"},
			{"cost": 250, "effect": 0.30, "desc": "+30% Attack"},
			{"cost": 400, "effect": 0.40, "desc": "+40% Attack"},
			{"cost": 500, "effect": 0.50, "desc": "+50% Attack"},
		],
	},
	"speed_boost": {
		"id": "speed_boost",
		...
		"max_level": 3,
		"levels": [
			{"cost": 200, "effect": 0.05, "desc": "+5% Move Speed"},
			{"cost": 400, "effect": 0.10, "desc": "+10% Move Speed"},
			{"cost": 600, "effect": 0.15, "desc": "+15% Move Speed"},
		],
	},
}
