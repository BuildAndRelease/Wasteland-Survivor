...
const BASE_SKILLS: Dictionary = {
	"rust_bullet": {
		...
		"cooldown": 1.0,
		"levels": [
			{"desc": "Fire rust bullet every 1s", "attack_interval": 1.0},
			{"desc": "Fire rate +50%", "attack_interval": 0.5},
			{"desc": "Double shot", "attack_interval": 0.5, "double_shot": true},
		],
	},
	"fire_bomb": {
		"id": "fire_bomb",
		...
		"levels": [
			...
			{"desc": "Ground fire 5s", "duration": 5.0, "radius": 90.0, "damage_per_tick": 5, "tick_interval": 0.5},
		],
	},
	"poison_gas": {
		"id": "poison_gas",
		...
		"levels": [
			...
			{"desc": "Fog lasts 8s", "duration": 8.0, "radius": 70.0, "slow_amount": 0.5, "damage_per_tick": 6, "tick_interval": 0.5},
		],
	},
	"emp_pulse": {
		"id": "emp_pulse",
		...
		"levels": [
			...
			{"desc": "Stun 2s", "radius": 150.0, "stun_duration": 2.0, "damage": 15},
		],
	},
	"scrap_shield": {
		"id": "scrap_shield",
		...
		"cooldown": 0.0,
		"levels": [
			{"desc": "-10% damage taken", "damage_reduction": 0.1},
			{"desc": "-20% damage taken", "damage_reduction": 0.2},
			{"desc": "Reflect melee damage", "damage_reduction": 0.2, "reflect_melee": true},
		],
	},
	"scavenger_instinct": {
		...
		"cooldown": 0.0,
		"levels": [
			{"desc": "XP range +30%", "xp_range_mult": 1.3},
			{"desc": "XP range +50%", "xp_range_mult": 1.5},
			{"desc": "Auto-collect all screen XP", "xp_range_mult": 10.0},
		],
	},
	"spike_trap": {
		"id": "spike_trap",
		...
		"levels": [
			...
			{"desc": "Traps explode", "damage": 20, "slow_amount": 0.5, "slow_duration": 2.0, "trap_count": 2, "duration": 6.0, "explode": true},
		],
	},
	"mutant_regen": {
		"id": "mutant_regen",
		...
		"cooldown": 0.0,
		"levels": [
			{"desc": "Regen 1% HP/s", "regen_percent": 0.01},
			{"desc": "Regen 2% HP/s", "regen_percent": 0.02},
			{"desc": "Below 30% HP: regen x3", "regen_percent": 0.02, "low_hp_multiplier": 3.0, "low_hp_threshold": 0.3},
		],
	},
	"rage_injection": {
		"id": "rage_injection",
		...
		"levels": [
			...
			{"desc": "Immune to CC during", "attack_speed_mult": 1.5, "duration": 5.0, "cc_immune": true},
		],
	},
	"iron_fist": {
		"id": "iron_fist",
		...
		"levels": [
			...
			{"desc": "Add stun", "damage": 30, "range": 80.0, "cone_angle": 60.0, "knockback": 200.0, "stun_duration": 1.0},
		],
	},
}
